...
name: rework-commits
description: >-
  Rework a branch into a sequence of small, semantic commits for review. Use when
  the user asks to split commits, rework commit history, or create reviewable commits.
